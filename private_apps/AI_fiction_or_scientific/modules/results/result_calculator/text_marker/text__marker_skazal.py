...
def run():
    analyzed_text = text__marker.calc('сказал')
    fiction_mean = fiction_indicators.TEXT__MARKER_SKAZAL
    scientific_mean = scientific_indicators.TEXT__MARKER_SKAZAL
    fiction_and_scientific_mean = mean_calculator.run()[5]
