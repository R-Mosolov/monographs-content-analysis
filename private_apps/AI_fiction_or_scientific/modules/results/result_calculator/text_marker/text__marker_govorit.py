...
def run():
    analyzed_text = text__marker.calc('говорит')
    fiction_mean = fiction_indicators.TEXT__MARKER_GOVORIT
    scientific_mean = scientific_indicators.TEXT__MARKER_GOVORIT
    fiction_and_scientific_mean = mean_calculator.run()[7]
