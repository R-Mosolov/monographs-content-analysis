...
def run():
    analyzed_text = text__marker.calc('говорил')
    fiction_mean = fiction_indicators.TEXT__MARKER_GOVORIL
    scientific_mean = scientific_indicators.TEXT__MARKER_GOVORIL
    fiction_and_scientific_mean = mean_calculator.run()[8]
